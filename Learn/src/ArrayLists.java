...
public class ArrayLists {
    public static void learn(String[] args) throws Exception {
        ...
        // ! Elements can be added and removed from an ArrayList whenever you want ( at
        // run time)
        // ! ArrayLists can only store reference types (objects)
        // ! ArrayLists are indexed just like arrays
        // ! You cant change the size of list at runtime but you can add and remove
        // elements from it
        ...
        names.clear(); // ? This is how we clear all the elements from an ArrayList using the clear()
                       // method
        ...
        names.remove(1); // ? This is how we remove an element from an ArrayList using the remove()
                         // method
        ...
        for (int i = 0; i < names.size(); i++) {
            System.out.println(names.get(i)); // ? This is how we loop through an ArrayList using a for loop to print
                                              // all the elements
        }
    }
}
